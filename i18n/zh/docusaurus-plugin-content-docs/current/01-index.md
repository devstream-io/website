...
将 [examples/quickstart.yaml](https://github.com/devstream-io/devstream/blob/main/examples/quickstart.yaml) 和 [examples/tools-quickstart.yaml](https://github.com/devstream-io/devstream/blob/main/examples/tool-quickstart.yaml) 文件拷贝到你到工作目录下，然后重命名 quickstart.yaml 成 config.yaml：
